...
class SessionTest(unittest.TestCase):
    ...
    def test_attendees(self):
        ...
        a1 = Registrant(webinar=w, session=s, key=9583, first_name=u'J\u00f6hn', last_name=u'Smith', email=u'jsmith@test.com',
                        viewings=[(time('4/1/11 12:01'), time('4/1/11 12:22'))])
        a2 = Registrant(webinar=w, session=s, key=2305, first_name=u'Suzy', last_name=u'Samwell', email=u'ss@test.com',
                        viewings=[(time('4/1/11 12:02'), time('4/1/11 12:07')), (time('4/1/11 12:12'), time('4/1/11 12:17')),
    ...
    def test_registrants(self):
        w = Webinar(self.organizer, key=2394, timezone='America/New_York', sessions=[])
        s = Session(w, key=6043, started_at=time('2012-06-01'), attendees=[])
        r1 = Registrant(webinar=w, session=s, key=9583, first_name=u'J\u00f6hn', last_name=u'Smith', email=u'jsmith@test.com',
                        registered_at='5/1/12 18:01', join_url='http://bit.ly/482024', status='APPROVED',
                        viewings=[(time('4/1/11 12:01'), time('4/1/11 12:22'))])
        r2 = Registrant(webinar=w, session=s, key=2305, first_name=u'Suzy', last_name=u'Samwell', email=u'ss@test.com',
                        registered_at='5/2/12 18:02', join_url='http://bit.ly/8592932', status='APPROVED',
                        viewings=[(time('4/1/11 12:02'), time('4/1/11 12:07')), (time('4/1/11 12:12'), time('4/1/11 12:17')),
                                  (time('4/1/11 12:22'), time('4/1/11 12:27'))])
        r3 = Registrant(webinar=w, session=s, key=4203, first_name=u'Todd', last_name=u'Kells', email=u'tkells@test.com',
                        registered_at='5/3/12 18:03', join_url='http://bit.ly/9293842', status='WAITING', viewings=[])
        with mocker(GetAttendees, text=self.attendees_json):
