...
class WebinarTest(unittest.TestCase):
    ...
    def test_registrations(self):
        ...
        ra = Registrant(webinar=w, key=9583, first_name=u'J\u00f6hn', last_name=u'Smith', email=u'jsmith@test.com',
                        registered_at='5/1/12 18:01', join_url='http://bit.ly/482024', status='WAITING')
        rb = Registrant(webinar=w, key=2305, first_name=u'Suzy', last_name=u'Samwell', email=u'ss@test.com', registered_at='4/2/12 18:02',
                        join_url='http://bit.ly/8583932', status='DELETED')
        rc = Registrant(webinar=w, key=2306, first_name=u'Suzy', last_name=u'Samwell', email=u'ss@test.com', registered_at='5/2/12 18:02',
                        join_url='http://bit.ly/8592932', status='APPROVED')
    ...
    def test_registrants(self):
        ...
        ra = Registrant(webinar=w, key=9583, first_name=u'J\u00f6hn', last_name=u'Smith', email=u'jsmith@test.com',
                        registered_at='5/1/12 18:01', join_url='http://bit.ly/482024', status='WAITING')
        rb = Registrant(webinar=w, key=2306, first_name=u'Suzy', last_name=u'Samwell', email=u'ss@test.com', registered_at='5/2/12 18:02',
                        join_url='http://bit.ly/8592932', status='APPROVED')
        with mocker(GetRegistrations, text=self.registrations_json):
